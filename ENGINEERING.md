...
M4's per-commit evidence is live. The current development suite passes 276/276
...
the public Curl path/header/SSE case. The provider slice passes 47/47 tests,
